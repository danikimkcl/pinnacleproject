...
```{r, fig.width = 10, fig.height = 6}
plot_pd_ppc_adj = plot_forest_meta(ors_pd_ppc_adj[-c(1, 7), ])
...
plot_pd_poth_adj = plot_forest_meta(ors_pd_poth_adj[-c(1, 3, 7), ])
plot_pnism_poth_adj = plot_forest_meta(ors_pnism_poth_adj[-c(1, 7), ])

plot_pd_ppd_adj = plot_forest_meta(ors_pd_ppd_adj[-c(1:2), ])
plot_pnism_ppd_adj = plot_forest_meta(ors_pnism_ppd_adj[-c(1:2), ])

plot_pd_pdent_adj = plot_forest_meta(ors_pd_pdent_adj[-c(1), ])
plot_pnism_pdent_adj = plot_forest_meta(ors_pnism_pdent_adj[-c(1), ])
